...
@property (nonatomic, copy) void (^zanButtonClickedBlock)(NSIndexPath *indexPath);
@property (nonatomic, copy) void (^replyButtonClickedBlock)(NSIndexPath *indexPath);
@property (nonatomic, copy) void (^shareButtonClickedBlock)(NSIndexPath *indexPath);

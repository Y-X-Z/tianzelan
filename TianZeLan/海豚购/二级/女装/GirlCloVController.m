...
@interface GirlCloVController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,SDCycleScrollViewDelegate,WKUIDelegate,WKNavigationDelegate>{
...
@implementation GirlCloVController
...
- (void)viewDidLoad {
    ...
    [_WebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://s.click.taobao.com/LEMJzPw"]]];
...
-(void)makeui{
    ...
    _headScroview.autoScrollTimeInterval=2;
    ...
    headerview = [YX_myUI createViewWithFrame:CGRectMake(0, 0, kScreenW, 380) Backgroundcolor:RGBA(241, 241, 241, 1)];
    ...
    NormalCollection=[[UICollectionView alloc]initWithFrame:CGRectMake(0,0,kScreenW,self.view.frame.size.height)collectionViewLayout:flow];

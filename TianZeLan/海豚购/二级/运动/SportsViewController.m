...
@interface SportsViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WKUIDelegate,WKNavigationDelegate>{
...
- (void)viewDidLoad {
    ...
    [_WebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://s.click.taobao.com/zzlJzPw"]]];

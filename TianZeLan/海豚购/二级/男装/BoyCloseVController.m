...
@interface BoyCloseVController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WKUIDelegate,WKNavigationDelegate>{
...
@implementation BoyCloseVController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [_WebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://s.click.taobao.com/fmDKzPw"]]];

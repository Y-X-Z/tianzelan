...
@interface MeiZhViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WKUIDelegate,WKNavigationDelegate>{
...
@implementation MeiZhViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [_WebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://s.click.taobao.com/6fqXyPw"]]];

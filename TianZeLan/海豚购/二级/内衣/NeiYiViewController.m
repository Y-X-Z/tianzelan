...
@interface NeiYiViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,WKUIDelegate,WKNavigationDelegate>{
...
@implementation NeiYiViewController
...
- (void)viewDidLoad {
    ...
    [_WebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://s.click.taobao.com/8sAKzPw"]]];
